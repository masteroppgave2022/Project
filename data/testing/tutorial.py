...
class sentinel1_download_preprocess():
    def __init__(self, input_dir, date_1, date_2, query_style, footprint, lat=24.84, lon=90.43, download=False):
        ...
        self.footprint = "POLYGON ((6.56982421875 62.44124178683124, 11.9091796875 62.44124178683124, 11.9091796875 64.57675354022054, 6.56982421875 64.57675354022054, 6.56982421875 62.44124178683124))"#geojson_to_wkt(read_geojson(footprint))
        self.lat = lat
        self.lon = lon
        self.download = download

        # configurations
        self.api = SentinelAPI('renatask', '#Voff123', 'https://scihub.copernicus.eu/dhus')
